...
import top.wujinxing.blog.util.ConstraintViolationExceptionHandler;
...
@PreAuthorize("hasAuthority('ROLE_ADMIN')")     //指定角色才能操作方法
public class UserController {
    ...
    public ModelAndView list(@RequestParam(value = "async", required = false) boolean async,
        ...
        List<User> list = page.getContent();    //当前所在页面的数据列表

        model.addAttribute("page",page);
        model.addAttribute("userList", list);
        return new ModelAndView(async == true? "users/list :: #mainContainerReplease":"users/list", "userModel", model);
    }
